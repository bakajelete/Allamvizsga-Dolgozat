...
class Page4:
    ...
    def __init__(self, root):
        ...
        self.one_week_B50 = Button(root, text="One week B50", command = lambda: self.change_vizualization_50(self, 5))
        self.one_week_B200 = Button(root, text="One week B200", command = lambda: self.change_vizualization_200(self, 5))
        
        self.one_month_B50 = Button(root, text="One month B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(months=1))))
        self.one_month_B200 = Button(root, text="One month B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(months=1))))
        
        self.three_monts_B50 = Button(root, text="Three monts B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(months=3))))
        self.three_monts_B200 = Button(root, text="Three monts B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(months=3))))
        
        self.six_monts_B50 = Button(root, text="Six monts B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(months=6))))
        self.six_monts_B200 = Button(root, text="Six monts B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(months=6))))
        
        self.one_year_B50 = Button(root, text="One year B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(years=1))))
        self.one_year_B200 = Button(root, text="One year B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(years=1))))
        
        self.three_years_B50 = Button(root, text="Three years B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(years=3))))
        self.three_years_B200 = Button(root, text="Three years B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(years=3))))
        
        self.five_years_B50 = Button(root, text="Five years B50", command = lambda: self.change_vizualization_50(self, self.get_days_nr(self.now - relativedelta(years=5))))
        self.five_years_B200 = Button(root, text="Five years B200", command = lambda: self.change_vizualization_200(self, self.get_days_nr(self.now - relativedelta(years=5))))
        
        self.max_time_B50 = Button(root, text="Max time B50", command = lambda: self.change_vizualization_50(self, self.data_time_size))
        self.max_time_B200 = Button(root, text="Max time B200", command = lambda: self.change_vizualization_200(self, self.data_time_size))
        ...
        self.show_B50 = Button(root, text="Show B50")
        self.show_B50.bind('<Button-1>', self.change_vizualization_custom_B50)
        
        self.show_B200 = Button(root, text="Show B200")
    ...
    def new_vizualization_50(self, period):
        ...
        time_period['STD_lo1'] = time_period.apply(lambda x: x['SMA50'] - 2 * std, axis=1)
        time_period['STD_lo2'] = time_period.apply(lambda x: x['SMA50'] - std, axis=1)
    ...
    def new_vizualization_200(self, period):
        ...
        time_period['STD_lo1'] = time_period.apply(lambda x: x['SMA200'] - 2 * std, axis=1)
        time_period['STD_lo2'] = time_period.apply(lambda x: x['SMA200'] - std, axis=1)
    ...
    def change_vizualization_custom_B50(self, event):
        ...
        custom_period['STD_lo1'] = custom_period.apply(lambda x: x['SMA50'] - 2 * std, axis=1)
        custom_period['STD_lo2'] = custom_period.apply(lambda x: x['SMA50'] - std, axis=1)
    ...
    def change_vizualization_custom_B200(self, event):
        ...
        custom_period['STD_lo1'] = custom_period.apply(lambda x: x['SMA200'] - 2 * std, axis=1)
        custom_period['STD_lo2'] = custom_period.apply(lambda x: x['SMA200'] - std, axis=1)
