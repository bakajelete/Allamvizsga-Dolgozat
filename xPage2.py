...
class Page2:
    ...
    def __init__(self, root):
        ...
        #self.one_year.place(x=30*self.box_x, y=2*self.box_y, width=5*self.box_x, height=1*self.box_y)
        ...
        #self.five_years.place(x=30*self.box_x, y=5*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.max = Button(root, text="Max time", command = lambda: self.change_vizualization(self, self.max_time))
        #self.max.place(x=30*self.box_x, y=8*self.box_y, width=5*self.box_x, height=1*self.box_y)
        ...
        #self.more_detail.place(x=30*self.box_x, y=11*self.box_y, width=5*self.box_x, height=1*self.box_y)
        ...
        #self.subplot.tick_params(axis='x', labelsize=3)
    ...
    def resize_window(self, event):
        ...
        self.analize_03.place(x=22*self.box_x, y=16*self.box_y, width=5*self.box_x, height=1*self.box_y)
                ...
                #_____Graph abouth the data_____
        self.subplot.set_ylabel('Value($)', fontsize=6 * self.font)
        self.subplot.set_xlabel('Time(day)', fontsize=6 * self.font)
        self.subplot.tick_params(axis='x', labelsize=8 * self.font)
        self.subplot.tick_params(axis='y', labelsize=12 * self.font)
        self.plots.get_tk_widget().place(x=5*self.box_x, y=2*self.box_y, width=25*self.box_x, height=14*self.box_y)
