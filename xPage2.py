...
class Page2:
    ...
    def __init__(self, root):
        ...
        self.analize_01 = Button(root, text="Bell model")
        self.analize_01.bind('<Button-1>', self.change_page_to_analize_01)

        self.analize_02 = Button(root, text="ARIMA")
        self.analize_02.bind('<Button-1>', self.change_page_to_analize_02)

        self.analize_03 = Button(root, text="Polynomial regression")
    ...
    def resize_window(self, event):
        ...
        self.one_year.place(x=self.x_len-5*self.box_x, y=2*self.box_y, width=5*self.box_x, height=1*self.box_y)
        self.five_years.place(x=self.x_len-5*self.box_x, y=5*self.box_y, width=5*self.box_x, height=1*self.box_y)
        self.max_time.place(x=self.x_len-5*self.box_x, y=8*self.box_y, width=5*self.box_x, height=1*self.box_y)
        
                #_____Buttons for page change_____
        self.more_detail.place(x=self.x_len-5*self.box_x, y=11*self.box_y, width=5*self.box_x, height=1*self.box_y)
        self.analize_01.place(x=8*self.box_x, y=17*self.box_y, width=5*self.box_x, height=1*self.box_y)
        self.analize_02.place(x=15*self.box_x, y=17*self.box_y, width=5*self.box_x, height=1*self.box_y)
        self.analize_03.place(x=22*self.box_x, y=17*self.box_y, width=5*self.box_x, height=1*self.box_y)

                #_____Graph abouth the data_____
        self.subplot.tick_params(axis='x', labelsize = self.x_font)
        self.subplot.tick_params(axis='y', labelsize = self.y_font)
        
        self.plots.get_tk_widget().place(x=5*self.box_x, y=1*self.box_y, width=25*self.box_x, height=14*self.box_y)

                #_____Label for information of the graph_____
        self.graph_info.place(x=9*self.box_x, y=15*self.box_y, width=17*self.box_x, height=1*self.box_y)
