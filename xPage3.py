...
class Page3:
    ...
    def __init__(self, root):
        ...
        self.one_week.place(x=1*self.box_x, y=1*self.box_y, width=5*self.box_x, height=1*self.box_y)
        ...
        self.one_week.place(x=1*self.box_x, y=7*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Three monts")
        self.one_week.bind('<Button-1>', self.change_vizualization_tm)
        self.one_week.place(x=1*self.box_x, y=10*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Six monts")
        self.one_week.bind('<Button-1>', self.change_vizualization_sm)
        self.one_week.place(x=1*self.box_x, y=13*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="One year")
        self.one_week.bind('<Button-1>', self.change_vizualization_oy)
        self.one_week.place(x=1*self.box_x, y=16*self.box_y, width=5*self.box_x, height=1*self.box_y)


        self.one_week = Button(root, text="Two years")
        self.one_week.bind('<Button-1>', self.change_vizualization_twoy)
        self.one_week.place(x=29*self.box_x, y=1*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Three years")
        self.one_week.bind('<Button-1>', self.change_vizualization_thry)
        self.one_week.place(x=29*self.box_x, y=4*self.box_y, width=5*self.box_x, height=1*self.box_y)
        
        self.one_week = Button(root, text="Five years")
        self.one_week.bind('<Button-1>', self.change_vizualization_fy)
        self.one_week.place(x=29*self.box_x, y=7*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Ten years")
        self.one_week.bind('<Button-1>', self.change_vizualization_teny)
        self.one_week.place(x=29*self.box_x, y=10*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Twenty years")
        self.one_week.bind('<Button-1>', self.change_vizualization_twey)
        self.one_week.place(x=29*self.box_x, y=13*self.box_y, width=5*self.box_x, height=1*self.box_y)

        self.one_week = Button(root, text="Maximum time")
        self.one_week.bind('<Button-1>', self.change_vizualization_mt)
        self.one_week.place(x=29*self.box_x, y=16*self.box_y, width=5*self.box_x, height=1*self.box_y)
    ...
    def change_initial_vizualization(self):
        ...
        print(self.max_time, company_data)
