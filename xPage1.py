...
class Page1:
    ...
    def resize_window(self, event):
        ...
        self.box_x = int(self.root.winfo_width()/35)
        self.box_y = int(self.root.winfo_height()/18)
        ...
        self.search.place(x=23*self.box_x, y=0, width=4*self.box_x, height=1*self.box_y)
            ...
            #G1
        self.subplot1.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot1.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot1.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot1.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)
        
        self.plots1.get_tk_widget().place(x=0, y=3*self.box_y, width=11*self.box_x, height=7*self.box_y)
        
            #G2
        self.subplot2.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot2.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot2.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot2.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)

        self.plots2.get_tk_widget().place(x=12*self.box_x, y=3*self.box_y, width=11*self.box_x, height=7*self.box_y)
        
            #G3
        self.subplot3.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot3.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot3.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot3.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)
        
        self.plots3.get_tk_widget().place(x=24*self.box_x, y=3*self.box_y, width=11*self.box_x, height=7*self.box_y)

            #G4
        self.subplot4.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot4.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot4.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot4.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)
        
        self.plots4.get_tk_widget().place(x=0, y=11*self.box_y, width=11*self.box_x, height=7*self.box_y)

            #G5
        self.subplot5.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot5.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot5.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot5.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)
        
        self.plots5.get_tk_widget().place(x=12*self.box_x, y=11*self.box_y, width=11*self.box_x, height=7*self.box_y)

            #G6
        self.subplot6.set_ylabel('Value($)', fontsize=self.box_x*4/ 22)
        self.subplot6.set_xlabel('Time(day)', fontsize=self.box_x*4/ 22)
        self.subplot6.tick_params(axis='x', labelsize=self.box_x*3.3/ 22)
        self.subplot6.tick_params(axis='y', labelsize=self.box_x*6.6/ 22)
